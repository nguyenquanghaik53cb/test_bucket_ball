(function(){ 
  ...
  this.templates["left_user_box"] = function anonymous(data) {
var a,div,i,p,s,span,time,u;a = function(){return __ck.tag('a', arguments);};div = function(){return __ck.tag('div', arguments);};i = function(){return __ck.tag('i', arguments);};p = function(){return __ck.tag('p', arguments);};s = function(){return __ck.tag('s', arguments);};span = function(){return __ck.tag('span', arguments);};time = function(){return __ck.tag('time', arguments);};u = function(){return __ck.tag('u', arguments);};var __slice = Array.prototype.slice;var __hasProp = Object.prototype.hasOwnProperty;var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };var __extends = function(child, parent) {  for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }  function ctor() { this.constructor = child; }  ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype;  return child; };var __indexOf = Array.prototype.indexOf || function(item) {  for (var i = 0, l = this.length; i < l; i++) {    if (this[i] === item) return i;  } return -1; };
...
/*
<div class="case phase01">
    <div class="name_hd cf">
      <p class="name">ユーザー001</p>
      <p class="url">/event/..</p>
      </div>
      <p class="visit">2回</p>
      <p class="time"><span>120</span>分<span>50</span>秒</p>
  </div>
*/
